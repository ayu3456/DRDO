...
LoopClosing::LoopClosing(Atlas *pAtlas, KeyFrameDatabase *pDB, ORBVocabulary *pVoc, const bool bFixScale, const bool bActiveLC):
    ...
    mbStopGBA(false), mpThreadGBA(NULL), mbFixScale(bFixScale), mnLoopNumCoincidences(0), mnFullBAIdx(0), mnMergeNumCoincidences(0),
    mbLoopDetected(false),  mnLoopNumNotFound, mbMergeDetected(false)(0), mnMergeNumNotFound(0), mbActiveLC(bActiveLC)
{
