...
### Setting it UP on local using VMware Fusion and UBUNTU 20.04

This was a final project in which we implemented and used ORB_SLAM3 to perform Visual SLAM on a variety of data we collected ourselves, including data recorded with the NUance autonomous car. **However, this guide is completely general and can be used by anyone to collect data and process it using ORB_SLAM3.**

![](https://user-images.githubusercontent.com/83112082/161122619-1058b1d1-7834-442d-bf6a-d888db4a47ef.gif)
...
We're using python3, and need numpy and matplotlib. Install pip for Python 3 and required dependencies:
